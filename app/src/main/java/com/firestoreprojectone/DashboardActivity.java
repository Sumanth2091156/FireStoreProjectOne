...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msgWelcome.setText(getIntent().getStringExtra("message"));
        View.OnClickListener listener = new View.OnClickListener() {
            public void onClick(View view) {
                Fragment fragment = null;
                if (view == findViewById(R.id.ClickbtnProfile)) {
                    fragment = new MyProfileFragmentpage();
                }
        ...
        Button ClickbtnProfile = (Button) findViewById(R.id.ClickbtnProfile);
        ClickbtnProfile.setOnClickListener(listener);
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
               ...
               /*     case R.id.myprofile:
                    ...
                    case R.id.logout:
                        Intent logout = new Intent(getApplicationContext(), MainActivityPage.class);
